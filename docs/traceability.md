...
| `SPEC-ADMIN-07` | `REQ-060`, `REQ-111`, `REQ-112`, `REQ-113`, `REQ-114`, `REQ-119` | `CR-05/Q16`, `CR-06/Q04`, `CR-06/Q11`, `CR-06/Q13`, `CR-06/Q14`, `CR-07/Q01` | `CASE-ADMIN-18`, `CASE-ADMIN-19` | `test_CASE_ADMIN_18_pointage_du_solde_sans_transaction`, `test_CASE_ADMIN_19_pointage_reversible_et_trace` | `33e9077`, `ba5848f`, `be32351` |
...
| `SPEC-BOOKING-12` | `REQ-017`, `REQ-111`, `REQ-112`, `REQ-117` | `CR-01/Q10`, `CR-06/Q04`, `CR-06/Q09`, `CR-07/Q01` | `CASE-BOOKING-40`, `CASE-BOOKING-41`, `CASE-BOOKING-42` | `test_CASE_BOOKING_40_solde_regle_en_ligne_en_une_transaction`, `test_CASE_BOOKING_41_solde_non_reglable_hors_fenetre`, `test_CASE_BOOKING_42_solde_nul_et_creneau_annule` | `33e9077`, `ba5848f`, `916d0a6` |
...
| `SPEC-CANCEL-07` | `REQ-120`, `REQ-121` | `CR-07/Q09`, `CR-07/Q10` | `CASE-CANCEL-25` | `test_CASE_CANCEL_25_lien_de_reglement_envoye_a_sept_heures_la_veille`, `test_CASE_CANCEL_25_lien_envoye_des_lacompte_pour_une_reservation_tardive` | — |

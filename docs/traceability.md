...
| `SPEC-BOOKING-07` | `REQ-017`, `REQ-018` | `CR-01/Q10`, `CR-01/Q11` | `CASE-BOOKING-09`, `CASE-BOOKING-10`, `CASE-BOOKING-11`, `CASE-BOOKING-12`, `CASE-BOOKING-13` | — | `87891be`, `0d28879` |
| `SPEC-BOOKING-08` | `REQ-035`, `REQ-101` | `déduit` | `CASE-BOOKING-37` | — | `45cf006`, `8091450` |
| `SPEC-BOOKING-09` | `REQ-043`, `REQ-044`, `REQ-045`, `REQ-046`, `REQ-047`, `REQ-048`, `REQ-049` | `CR-03/Q07`, `CR-04/Q01` | `CASE-BOOKING-14`, `CASE-BOOKING-15`, `CASE-BOOKING-16`, `CASE-BOOKING-17`, `CASE-BOOKING-18`, `CASE-BOOKING-19` | — | `00e60f8`, `33656ed`, `deaf28b`, `392a2ab` |
...
| 63 des 79 cas automatisables n'ont pas encore de test | J6 | les cas viennent d'être écrits ; l'automatisation est une tâche de production de l'agent, qui ne peut pas être lancée avant le plan de délégation (README §6bis) | 16 tests écrits à J7 pour les deux spécifications les plus exposées, `SPEC-BOOKING-03` et `SPEC-CANCEL-06` ; les 63 restants suivent l'ordre de `docs/strategie-de-test.md` §8 |
...
| Les 16 tests écrits sont tous au rouge | J7 | ils sont écrits avant le code, sur l'API que fixent `docs/architecture.md` §3 et §4 ; aucune classe de `src/` n'existe encore, le socle technique étant monté à J8 | attendu et assumé : chaque test nomme en clair la classe de production qui lui manque, et passe au vert quand la tâche de délégation correspondante est livrée |

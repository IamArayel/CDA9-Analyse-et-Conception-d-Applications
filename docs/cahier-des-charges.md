...
| R-15 | Le gérant peut placer un créneau en alerte météo depuis l'espace de gestion, créneau par créneau ; l'alerte court jusqu'à l'heure de début de la sortie | [CR-05/Q08](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues), [Q07](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
...
| REQ-052 | Le gérant peut placer un créneau en **alerte météo** depuis l'espace de gestion, créneau par créneau et indépendamment des autres. Aucune alerte n'est déclenchée automatiquement. | Must | Gérant | [CR-05/Q08](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
...
| REQ-054 | Si le créneau en alerte est annulé, un message de confirmation est envoyé 2 heures avant l'heure de départ prévue. S'il est maintenu, aucun message supplémentaire n'est envoyé : l'absence de message vaut maintien. | Must | Client | [CR-05/Q01](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
...
| 11 | L'heure d'envoi de l'alerte (18h) et le délai de confirmation (2 heures avant le départ) sont-ils figés, ou réglables depuis l'espace de gestion comme l'horaire du message de rappel (REQ-042) ? | Non posée, identifiée le 2026-08-14 | en attente | Valeurs par défaut réglables, par cohérence avec REQ-042 (`CR-05` §6, ambiguïté 1) |
| 12 | Jusqu'à quelle heure le gérant peut-il annuler un créneau, et qu'envoie-t-on s'il décide après le repère des 2 heures ? | Non posée, identifiée le 2026-08-14 | en attente | Annulation possible jusqu'à l'heure de départ, message envoyé immédiatement au lieu d'être programmé (`CR-05` §6, ambiguïté 2) |
...
| v5 | 2026-08-14 | non | Intègre le cinquième entretien ([CR-05](./compte-rendu-entretien-05.md)) : alerte météo préventive (REQ-052 à REQ-055), annonce des annulations par écrit (REQ-026, REQ-057), REQ-023 et REQ-024 inversées après correction d'une lecture erronée de CR-02/Q04, REQ-019 et REQ-050 précisées, REQ-056 et REQ-058 ajoutées ; ajoute REQ-059 (immobilisation des places), issue d'une décision d'équipe et non du client. Documenté dans [impact-CR-003.md](./impact-CR-003.md) |

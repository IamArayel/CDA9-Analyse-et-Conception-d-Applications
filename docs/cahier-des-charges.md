...
| 3 | Ne plus gérer les annulations météo à la main, créneau par créneau | Le gérant peut visualiser les clients inscrits sur un créneau, les alerter d'un risque d'annulation, puis annuler ; les clients concernés sont prévenus par écrit et remboursés intégralement, sans qu'il ait à téléphoner |

## 4. Parties prenantes

| Partie prenante | Rôle | Ce qu'elle attend | Utilise l'application ? |
|---|---|---|---|
| Gérant / armateur | Seul utilisateur prévu de l'outil à ce stade ; modifie les tarifs, met un créneau en alerte météo, décide seul des annulations, valide les remboursements ; ne téléphone plus aux clients pour les prévenir | Ne plus suivre les réservations à la main | oui |
| Client / passager | Réserve et paie en ligne, choisit sa sortie (dauphins/baleines) parmi les places disponibles affichées, est averti par écrit d'un risque d'annulation puis de la décision, appelle lui-même le gérant s'il veut annuler ou reporter | Réserver et payer simplement en ligne, être informé en cas de changement | oui |
...
- Contexte d'usage : consulte l'espace de gestion depuis un ordinateur pour ajuster les tarifs et suivre le planning ; décide seul d'une alerte puis d'une annulation météo, souvent
  dans l'urgence, sans avoir à appeler qui que ce soit.
...
- Alerter les clients d'un risque d'annulation la veille d'une sortie, puis
  leur confirmer l'annulation par écrit 2 heures avant le départ *(ajouté en
  v5, [CR-05/Q01](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues))*.
...
| 10 | L'envoi de SMS impose un prestataire tiers supplémentaire et un numéro de mobile joignable, alors que le formulaire ne collectait jusqu'ici qu'un téléphone au format libre | technique | [CR-05/Q02](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| 11 | La suppression de l'appel du gérant vers le client retire le dernier rattrapage humain d'un message non délivré : le silence vaut maintien de la sortie | métier | [CR-05/Q03](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues), [Q04](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
...
spécification.
| R-25 | La commission retenue sur une annulation à l'initiative du client est plafonnée au montant effectivement encaissé ; aucun solde n'est réclamé au client | [CR-06/Q01](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| R-26 | Une réservation de sortie exige un acompte de 30 % du montant total, une privatisation un acompte de 50 % du forfait. Le versement de l'acompte confirme la réservation | [CR-06/Q03](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues), points 1 et 2 de l'entretien |
| R-27 | Le solde se règle soit en ligne, entre l'envoi du lien de règlement (7h la veille) et l'heure de fermeture du créneau, soit par carte sur place le jour de la sortie | *déduit* pour la borne, [CR-06/Q05](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| R-28 | Une réservation portant un bon cadeau ou un avoir n'a pas d'acompte : le code solde la réservation, ou la différence est due en totalité au moment de réserver | [CR-06/Q06](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| R-29 | Le solde encaissé sur place ne passe pas par l'outil : le gérant le pointe comme réglé, et ce pointage est réversible et tracé | [CR-06/Q04](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues), [CR-06/Q14](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| R-30 | Un client absent au départ est traité comme un client qui annule | [CR-06/Q15](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| R-31 | Ce que le client récupère sur une annulation qu'il demande se calcule sur **ce qu'il a versé**, et non sur le prix : la totalité de l'acompte au-delà de 7 jours, 75 % de l'acompte entre 7 jours et 48 heures, et en deçà de 48 heures le versé diminué d'une commission de 50 % du prix total, plafonnée à zéro. Un client absent après avoir soldé ne récupère rien. *Les deux premières tranches portent sur l'acompte, la troisième sur le prix total : la formule n'est pas uniforme, et c'est voulu* | [CR-07/Q11](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues), [CR-07/Q03](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues), [CR-07/Q05](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) |
| R-32 | Un lien de règlement du solde part par courriel à 7h la veille de la sortie, quel que soit le créneau, ou dès l'encaissement de l'acompte si la réservation est prise après cette heure. Il est tracé comme les trois autres messages automatiques | [CR-07/Q09](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues), [CR-07/Q02](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues), [CR-07/Q10](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) |
| R-33 | Deux factures sont émises : une facture d'acompte à son encaissement, une facture de solde reprenant le total et référençant la première | [CR-07/Q07](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) |
...
| R-05 | Barème de remboursement dégressif selon le délai avant départ : 100 % au-delà de 7 jours, 25 % de commission entre 7 jours et 48 heures, 50 % de commission entre 48 heures et 24 heures. *Une exception s'ajoute en v5 : si le créneau a été mis en alerte météo, le client qui renonce est remboursé intégralement quel que soit le délai (R-20).* **Depuis la v6, ce barème est un plafond et non un montant : la commission ne peut jamais excéder ce que le client a effectivement versé (R-25).** | [CR-01/Q13](./compte-rendu-entretien-01.md#2-questions-posées-et-réponses-obtenues), [§5-8](./compte-rendu-entretien-01.md#5-règles-métier-découvertes) |
...
| R-15 | Le gérant peut placer un créneau en alerte météo depuis l'espace de gestion, créneau par créneau ; l'alerte porte sur les deux bateaux du créneau et court jusqu'à l'heure de début de la sortie | [CR-05/Q08](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues), [Q07](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| R-16 | L'alerte part la veille à 18h ; si la sortie est annulée, un message de confirmation part 2 heures avant le départ ; si elle est maintenue, aucun message n'est envoyé | [CR-05/Q01](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| R-17 | Un créneau en alerte reste réservable, le risque étant signalé sur la plateforme avant la réservation | [CR-05/Q06](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| R-18 | Les messages partent systématiquement par SMS et par e-mail ; WhatsApp reste un secours sans garantie | [CR-05/Q02](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| R-19 | Le gérant ne prévient plus ses clients par téléphone : tout passe par écrit. Le client, lui, appelle le gérant pour ses propres annulations | [CR-05/Q03](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| R-20 | Une annulation décidée par le gérant donne toujours un remboursement intégral ; le choix entre report, avoir et remboursement ne vaut que pour une annulation à l'initiative du client. Un client qui renonce après une alerte est lui aussi remboursé intégralement | [CR-05/Q10](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues), [Q11](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) ; *corrige la lecture retenue de [CR-02/Q04](./compte-rendu-entretien-02.md#2-questions-posées-et-réponses-obtenues)* |
| R-21 | Les places sont immobilisées 15 minutes à la validation du formulaire, le temps du paiement, puis redeviennent disponibles | *Déduit* — décision d'équipe, [`ADR-003`](./adr/ADR-003-concurrence-derniere-place.md) |
| R-22 | L'heure d'envoi de l'alerte et le délai de confirmation sont réglables depuis l'espace de gestion ; 18h et 2 heures ne sont que des valeurs par défaut | [CR-05/Q16](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| R-23 | Le gérant peut annuler un créneau jusqu'à son heure de départ ; au-delà du repère des 2 heures, le message part immédiatement | [CR-05/Q17](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| R-24 | Les coordonnées sont contrôlées à la saisie : format de l'e-mail vérifié, numéro de téléphone normalisé | [CR-05/Q18](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
...
| REQ-059 | Les places d'une réservation sont immobilisées dès la validation du formulaire, pour une durée de 15 minutes, le temps que le client paie. Passé ce délai sans paiement, elles redeviennent disponibles. Un second client voit donc les places indisponibles avant de saisir sa carte, plutôt que d'être refusé après avoir payé. | Must | Client | *Déduit* — aucune règle de rétention n'a été demandée par le client ; décision d'équipe prise sur remarque du formateur, arbitrée dans [`adr/ADR-003-concurrence-derniere-place.md`](./adr/ADR-003-concurrence-derniere-place.md). La durée de 15 minutes est une hypothèse, voir [§11](#11-questions-restées-ouvertes) |
...
| REQ-009 | Lors de la réservation, le client fournit : nom, prénom, e-mail, **numéro de téléphone mobile**, nombre d'adultes et d'enfants, date et heure du créneau choisi, et type de sortie correspondant à la saison. Aucune information supplémentaire n'est demandée. *Précisé en v5 : le numéro doit être un mobile joignable, puisqu'il porte l'envoi des SMS (REQ-057)* | Must | Client | [CR-02/Q18](./compte-rendu-entretien-02.md#2-questions-posées-et-réponses-obtenues) (le client a exclu toute information particulière) ; liste précise des champs *déduite* par l'équipe — ce sont les informations minimales pour identifier le client, le contacter et composer le créneau |
...
| ID | Exigence | Priorité | Persona | Source |
|---|---|---|---|---|
| REQ-017 | À la réservation, le client verse en ligne, par carte bancaire, un **acompte de 30 %** du montant total pour une sortie, et de **50 %** du forfait pour une privatisation. Le solde se règle ensuite, soit en ligne, soit par carte sur place le jour de la sortie. Aucun autre moyen de paiement (espèces, virement, chèque) n'est accepté en ligne. ***Renversée en v6** : jusqu'à la v5, cette exigence imposait le paiement de la totalité au moment de réserver et interdisait explicitement l'acompte.* | Must | Client | [CR-01/Q10](./compte-rendu-entretien-01.md#2-questions-posées-et-réponses-obtenues), [Q12](./compte-rendu-entretien-01.md#2-questions-posées-et-réponses-obtenues), [§5-7](./compte-rendu-entretien-01.md#5-règles-métier-découvertes) ; *renversée par* [CR-06](./compte-rendu-entretien-06.md), points 1 et 2 |
...
| REQ-058 | Un remboursement est exécuté par le prestataire de paiement après validation du gérant depuis l'espace de gestion. La communication qui l'accompagne relève du prestataire, pas du site. | Must | Gérant | [CR-05/Q12](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |

| REQ-108 | L'acompte est de 30 % du montant total pour une sortie dauphins ou baleines. Son montant est arrondi au centime. | Must | Client | [CR-06](./compte-rendu-entretien-06.md), point 1 ; [CR-06/Q10](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| REQ-109 | L'acompte est de 50 % du forfait pour une privatisation de bateau. | Must | Client | [CR-06](./compte-rendu-entretien-06.md), point 2, confirmé par [CR-06/Q12](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) qui aligne la fenêtre de règlement du solde sur celle des sorties |
| REQ-110 | Le versement de l'acompte confirme la réservation : la place est décomptée, et le client compte dans le seuil de 6 inscrits de REQ-002. | Must | Client | [CR-06/Q03](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| REQ-111 | Le solde peut être réglé en ligne **entre l'envoi du lien de règlement (REQ-120) et l'heure de fermeture des réservations du créneau** (REQ-005). ***Précisée en v7** : la v6 faisait courir la fenêtre à partir de 24 heures avant le départ. Les deux formulations coïncident pour les créneaux de 7h et 10h et divergent de sept heures pour celui de 14h ; c'est le lien qui fait foi, un client ne pouvant pas régler avant de l'avoir reçu.* | Must | Client | [CR-07/Q01](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues), révisée par [CR-07/Q12](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) ; heure d'envoi du lien : [CR-07/Q09](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) |
| REQ-112 | Le solde peut être réglé par carte sur place le jour de la sortie. Cet encaissement ne passe pas par l'outil : le gérant le pointe comme réglé depuis l'espace de gestion. | Must | Gérant | [CR-06/Q04](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| REQ-113 | Le pointage d'un solde réglé sur place est réversible, et chaque pointage comme chaque annulation de pointage laisse une trace. | Must | Gérant | [CR-06/Q14](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| REQ-116 | Une réservation portant un bon cadeau ou un avoir n'est pas soumise à l'acompte : soit le code la solde entièrement, soit la différence est due en totalité au moment de réserver. | Must | Client | [CR-06/Q06](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| REQ-117 | L'acompte et le solde en ligne sont deux transactions distinctes chez le prestataire de paiement, rattachées à la même réservation. | Must | Client | [CR-06/Q09](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| REQ-119 | **Deux factures** sont émises par réservation : une facture d'acompte à l'encaissement de celui-ci, puis une facture de solde qui reprend le total et référence la première. Elle part que le solde ait été réglé en ligne ou pointé par le gérant après encaissement au quai. ***Renversée en v7** : la v6 prévoyait une facture unique acquittée à la fin, sur la réponse du client à CR-06/Q11. L'équipe a soulevé qu'un acompte encaissé rend la TVA exigible et impose sa propre facture ; le client a tranché pour deux factures distinctes.* | Should | Client | [CR-07/Q07](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) ; *renverse* [CR-06/Q11](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
| REQ-120 | Un lien de règlement du solde est envoyé au client **par courriel à 7h la veille de la sortie**, quel que soit le créneau. Pour une réservation prise après cette heure, il part dès l'encaissement de l'acompte. C'est le quatrième message automatique de l'outil, après ceux de REQ-025. | Must | Client | [CR-07/Q09](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) pour l'heure, [CR-07/Q02](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) pour la réservation tardive, [CR-07/Q12](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) pour l'ouverture de la fenêtre |
| REQ-121 | Le lien de règlement est tracé comme les trois autres messages automatiques : date d'envoi, destinataire, canal. | Should | Gérant | [CR-07/Q10](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues) |
### 9.4 Annulation et report à l'initiative du client

| ID | Exigence | Priorité | Persona | Source |
|---|---|---|---|---|
| REQ-019 | En cas d'annulation par le client, celui-ci choisit avec le gérant entre **un report, un avoir ou un remboursement**. Le montant remboursé suit un barème dégressif : 100 % au-delà de 7 jours avant le départ ; 25 % de commission retenue entre 7 jours et 48 heures avant le départ ; 50 % de commission retenue entre 48 heures et 24 heures avant le départ. La demande est organisée par téléphone avec le gérant, et non en autonomie sur le site ; un éventuel canal e-mail ne sert qu'à notifier une annulation déjà décidée par téléphone, jamais à en faire la demande. *Précisé en v5 : c'est bien ici, et non après une annulation météo, que se place le choix entre report, avoir et remboursement.* *Précisée en v6 : la commission retenue est **plafonnée au montant effectivement encaissé**. Elle ne peut donc pas atteindre 50 % lorsque le client n'a versé que son acompte de 30 %, et le solde manquant n'est pas réclamé ([CR-06/Q01](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues)).* | Must | Client | [CR-01/Q13](./compte-rendu-entretien-01.md#2-questions-posées-et-réponses-obtenues), [§5-8](./compte-rendu-entretien-01.md#5-règles-métier-découvertes) ; [CR-02/Q20](./compte-rendu-entretien-02.md#2-questions-posées-et-réponses-obtenues), [§5-9](./compte-rendu-entretien-02.md#5-règles-métier-découvertes) ; *précisé par le client le 2026-08-11* — répond à l'ambiguïté relevée en [CR-02/Q04](./compte-rendu-entretien-02.md#2-questions-posées-et-réponses-obtenues), [§6-4](./compte-rendu-entretien-02.md#6-ambiguïtés-détectées) |
| REQ-056 | Un client dont le créneau a été mis en alerte météo (REQ-052) et qui préfère renoncer est remboursé intégralement, quel que soit le délai avant le départ, y compris si la sortie a finalement lieu. Le risque d'annulation venant du gérant, le barème dégressif de REQ-019 ne s'applique pas. *Précisée en v6 : « intégralement » désigne la totalité de ce que le client a **effectivement versé** ([CR-06/Q07](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues)).* | Must | Client | [CR-05/Q10](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| REQ-020 | Le client peut reporter sa réservation à une autre date, y compris à moins de 24 heures du départ, sous réserve de disponibilité. Ce report est organisé par téléphone avec le gérant, et non en autonomie sur le site. *Complétée en v6 : l'acompte déjà versé suit la réservation reportée. Une annulation survenant après un report applique le taux de remboursement correspondant au délai de la réservation initiale ([CR-06/Q18](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues)).* | Must | Client | [CR-02/Q17](./compte-rendu-entretien-02.md#2-questions-posées-et-réponses-obtenues), [§5-6](./compte-rendu-entretien-02.md#5-règles-métier-découvertes) ; [Q20](./compte-rendu-entretien-02.md#2-questions-posées-et-réponses-obtenues), [§5-9](./compte-rendu-entretien-02.md#5-règles-métier-découvertes) |

| REQ-115 | La commission retenue sur une annulation à l'initiative du client est plafonnée au montant effectivement encaissé. Aucun solde n'est réclamé au client. Lorsque la commission est **inférieure** au montant encaissé, la différence lui est remboursée. | Must | Client | [CR-06/Q01](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) pour le plafond ; *déduit* pour la restitution de la différence, le client n'ayant raisonné que sur la tranche où le plafond joue en sa faveur. Question 19 du §11 |
| REQ-118 | Un client absent au départ est traité comme un client qui annule. | Must | Client | [CR-06/Q15](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) ; *le barème de REQ-019 n'ayant aucune tranche en deçà de 24 heures, le taux applicable est une hypothèse d'équipe, question 17 du §11* |
### 9.5 Alerte et annulation météo à l'initiative du gérant
...
| REQ-023 | Une fois l'annulation météo décidée, chaque client concerné est prévenu par écrit et **remboursé intégralement**. Aucun choix entre report, avoir et remboursement ne lui est proposé : ce choix ne vaut que pour une annulation à l'initiative du client (REQ-019). *Précisée en v6 : « intégralement » désigne la totalité de ce que le client a **effectivement versé**, soit l'acompte seul si le solde n'a pas été réglé ([CR-06/Q07](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues)).* | Must | Gérant | [CR-05/Q11](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) ; *exigence **inversée** en v5 : la rédaction issue de [CR-02/Q04](./compte-rendu-entretien-02.md#2-questions-posées-et-réponses-obtenues) rattachait à tort le choix à l'annulation météo. Identifiant conservé pour que la correction reste lisible ; voir [impact-CR-003](./impact-CR-003.md)* |
| REQ-024 | Aucun report n'est proposé au client à la suite d'une annulation météo : celle-ci donne lieu à un remboursement intégral (REQ-023). Un client qui souhaite malgré tout réserver une autre date le fait comme n'importe quel client, sur le site. | Won't | Gérant | [CR-02/Q06](./compte-rendu-entretien-02.md#2-questions-posées-et-réponses-obtenues) ; *précisé par le client le 2026-08-11* — répond au point resté sans réponse en [CR-02, §9](./compte-rendu-entretien-02.md#9-ce-que-nous-navons-pas-abordé) |
| REQ-026 | Les clients sont prévenus **par écrit** en cas d'annulation ou de modification, par SMS et par e-mail (REQ-057). Le gérant n'appelle plus ses clients pour les prévenir ; le client, lui, garde la possibilité d'appeler le gérant pour ses propres annulations. | Must | Gérant | [CR-05/Q03](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) ; *modifiée en v5, la rédaction issue de [CR-02/Q09](./compte-rendu-entretien-02.md#2-questions-posées-et-réponses-obtenues) imposait le téléphone* |
| REQ-052 | Le gérant peut placer un créneau en **alerte météo** depuis l'espace de gestion, créneau par créneau et indépendamment des autres. L'alerte porte sur le créneau entier, les deux bateaux compris. Aucune alerte n'est déclenchée automatiquement. | Must | Gérant | [CR-05/Q08](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues), [Q19](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| REQ-053 | La mise en alerte envoie aux clients inscrits, la veille de la sortie à 18h, un message annonçant que la sortie risque d'être annulée et que la décision leur sera communiquée 2 heures avant le départ. | Must | Client | [CR-05/Q01](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| REQ-054 | Si le créneau en alerte est annulé, un message de confirmation est envoyé 2 heures avant l'heure de départ prévue, à tout client inscrit au moment de l'annulation. S'il est maintenu, aucun message supplémentaire n'est envoyé : l'absence de message vaut maintien. Le gérant peut annuler jusqu'à l'heure de départ ; au-delà du repère des 2 heures, le message part immédiatement. | Must | Client | [CR-05/Q01](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues), [Q17](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues), [Q20](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| REQ-055 | Un créneau en alerte reste réservable, le risque d'annulation étant signalé au client sur la plateforme avant qu'il ne réserve. L'alerte court jusqu'à l'heure de début de la sortie. | Must | Client | [CR-05/Q06](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues), [Q07](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
| REQ-060 | Le gérant peut régler, depuis l'espace de gestion, l'heure d'envoi du message d'alerte et le délai de confirmation avant le départ. Les valeurs par défaut sont 18h la veille et 2 heures. | Should | Gérant | [CR-05/Q16](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
...
| REQ-114 | Le planning d'embarquement distingue les réservations soldées de celles dont le solde reste dû, afin que le gérant n'embarque pas un client qui n'a pas payé. | Must | Gérant | [CR-06/Q13](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues) |
...
| REQ-057 | Les messages envoyés au client par le site partent systématiquement **par SMS et par e-mail**. WhatsApp reste un canal de secours manuel, sans garantie de réception (REQ-027). | Must | Client | [CR-05/Q02](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) |
...
| REQ-047 | Si le montant total de la réservation est supérieur au montant du bon cadeau, le bénéficiaire paie la différence en carte bancaire, selon les mêmes règles de paiement que le reste (REQ-017). *Requalifiée en v6 : cette différence est due **en totalité au moment de réserver**, sans acompte. Une réservation portant un code échappe donc au régime d'acompte de REQ-017 ([CR-06/Q06](./compte-rendu-entretien-06.md#2-questions-posées-et-réponses-obtenues)).* | Must | Client | [CR-03/Q07](./compte-rendu-entretien-03.md#2-questions-posées-et-réponses-obtenues) ; *« prix de la sortie » précisé en « montant total de la réservation » en v4, échange oral du 2026-08-13* |
...
| REQ-050 | Un avoir accordé par le gérant à la suite d'une **annulation à l'initiative du client** (REQ-019), convenue par téléphone puis validée depuis l'espace de gestion, est délivré sous forme d'un code de réduction unique, que le client saisit au moment de payer une réservation future. | Must | Gérant, Client | [CR-03/Q05](./compte-rendu-entretien-03.md#2-questions-posées-et-réponses-obtenues) ; *origine corrigée en v5, [CR-05/Q11](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) : l'avoir ne vient pas d'une annulation météo* |
...
| 2 | ~~Quel est le budget d'hébergement et le budget total du projet ?~~ | Non posée jusqu'au 2026-08-14 | **répondue le 2026-08-14** : budget « illimité » pour l'exercice ([CR-05/Q05](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues)). Réponse de cadre pédagogique, qui ne vaut pas engagement d'exploitation | *sans objet* |
...
| 11 | ~~L'heure d'envoi de l'alerte (18h) et le délai de confirmation sont-ils figés, ou réglables depuis l'espace de gestion ?~~ | Posée le 2026-08-14 | **répondue le 2026-08-14** : réglables, 18h et 2 heures étant des valeurs par défaut ([CR-05/Q16](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues), REQ-060) | *sans objet* |
| 12 | ~~Jusqu'à quelle heure le gérant peut-il annuler un créneau ?~~ | Posée le 2026-08-14 | **répondue le 2026-08-14** : jusqu'à l'heure de départ, le message partant immédiatement au-delà du repère des 2 heures ([CR-05/Q17](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues)) | *sans objet* |
| 13 | Une sortie annulée faute d'atteindre 6 inscrits (REQ-003) déclenche-t-elle le même message de confirmation qu'une annulation météo ? | [CR-05/Q14](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues) | **sans réponse** : cas non abordé | Aucun message spécifique tant que le client n'a pas répondu |
| 14 | Quelle est la durée d'immobilisation des places pendant le paiement (REQ-059), et le client doit-il consentir explicitement à recevoir des SMS ? | Non posée, identifiée le 2026-08-14 | en attente | 15 minutes d'immobilisation (`ADR-003`) ; consentement recueilli par une mention au formulaire, à valider |
| 15 | Les SMS partent-ils d'une passerelle d'envoi affichant le nom de l'entreprise, l'abonnement mobile du gérant restant inchangé ? | Posée le 2026-08-14, réponse partielle ([CR-05/Q21](./compte-rendu-entretien-05.md#2-questions-posées-et-réponses-obtenues)) | en attente | Passerelle d'envoi sous le nom de l'entreprise. Envoyer depuis le téléphone du gérant rendrait impossible l'envoi automatique demandé, voir `CR-05` §6 ambiguïté 6 |
| 16 | ~~La fenêtre de paiement en ligne du solde court-elle bien de 24 heures avant le départ jusqu'à l'heure de fermeture du créneau ?~~ | CR-06 | **répondue le 2026-08-20** : non, elle s'ouvre avec le lien de règlement, à 7h la veille ([CR-07/Q12](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues), REQ-111 et REQ-120) | *sans objet* |
| 17 | Quel taux de retenue s'applique à une annulation, ou à une absence au départ, à moins de 24 heures ? | CR-06 | en attente | L'acompte est retenu en totalité, aucune tranche du barème de REQ-019 ne descendant sous 24 heures |
| 18 | ~~La facture unique doit-elle être émise par l'outil plutôt que par le prestataire, puisqu'un solde encaissé sur place lui est invisible ?~~ | CR-06 | **répondue le 2026-08-20** : la question de la facture unique est sans objet, le client ayant retenu deux factures distinctes ([CR-07/Q07](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues), REQ-119) | *sans objet* |
| 19 | Un client qui annule à plus de 48 heures récupère-t-il la part d'acompte qui excède la commission, soit 5 € sur une sortie à 100 € annulée à 5 jours et 30 € au-delà de 7 jours ? | CR-06 | en attente | Oui, la différence lui est remboursée (REQ-115). Le client n'a raisonné que sur la tranche 48h-24h |
| 20 | ~~Une réservation prise à moins de 24 heures du départ interdit-elle le paiement en ligne du solde ?~~ | CR-06 | **répondue le 2026-08-20** : non, le lien part dès l'encaissement de l'acompte et le solde reste réglable en ligne jusqu'à la fermeture du créneau ([CR-07/Q02](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues), REQ-120) | *sans objet* |
| 21 | ~~La « boutique » évoquée est-elle le lieu d'embarquement, ou un point de vente distinct avec ses propres horaires ?~~ | CR-06 | **répondue le 2026-08-20** : le lieu d'embarquement, sans horaire distinct ([CR-07/Q04](./compte-rendu-entretien-07.md#2-questions-posées-et-réponses-obtenues)) | *sans objet* |
...
| v5 | 2026-08-14 | non | Intègre le cinquième entretien ([CR-05](./compte-rendu-entretien-05.md)) : alerte météo préventive (REQ-052 à REQ-055), annonce des annulations par écrit (REQ-026, REQ-057), REQ-023 et REQ-024 inversées après correction d'une lecture erronée de CR-02/Q04, REQ-019 et REQ-050 précisées, REQ-056 et REQ-058 ajoutées ; ajoute REQ-059 (immobilisation des places), issue d'une décision d'équipe et non du client. Documenté dans [impact-CR-003.md](./impact-CR-003.md) . Intègre aussi le second passage du même jour (`CR-05/Q16` à `Q21`) : cinq hypothèses d'équipe confirmées, REQ-060 ajoutée, REQ-052 et REQ-054 précisées |
| v6 | 2026-08-19 | non | Intègre le sixième entretien ([CR-06](./compte-rendu-entretien-06.md)) : **REQ-017 renversée**, l'acompte remplaçant le paiement intégral qu'elle interdisait explicitement ; REQ-019, REQ-020, REQ-023, REQ-047 et REQ-056 précisées ; REQ-108 à REQ-119 ajoutées ; R-05 requalifiée en plafond et R-25 à R-30 ajoutées ; six questions ouvertes au §11, dont trois portent une hypothèse d'équipe. Documenté dans [impact-CR-004.md](./impact-CR-004.md) |
| v7 | 2026-08-20 | non | Intègre le septième entretien ([CR-07](./compte-rendu-entretien-07.md)) : **REQ-119 renversée**, deux factures au lieu d'une, l'acompte encaissé rendant la TVA exigible ; REQ-111 précisée, la fenêtre de règlement s'ouvrant avec le lien à 7h la veille et non 24 heures avant le départ ; REQ-120 et REQ-121 ajoutées (lien de règlement, quatrième message automatique) ; barème de remboursement chiffré en R-31 ; questions 16, 18, 20 et 21 du §11 fermées. Documenté dans [impact-CR-005.md](./impact-CR-005.md) |
...
- **Alerte météo** : état d'un créneau que le gérant juge menacé, sans avoir encore décidé de l'annuler. Le créneau reste réservable, le risque est signalé, et l'alerte court jusqu'à l'heure de départ.
- **Pré-réservation** : période de 15 minutes pendant laquelle les places d'une réservation sont immobilisées, le temps que le client paie.
...
La v5 ajoute une exigence `déduit` d'une nature différente des précédentes :
`REQ-059` (immobilisation des places pendant le paiement) ne vient d'aucun
échange client, mais d'une décision d'équipe prise sur remarque du formateur,
arbitrée dans [`ADR-003`](./adr/ADR-003-concurrence-derniere-place.md). Elle
est signalée comme telle plutôt que rattachée artificiellement à un entretien.

Cinq exigences de la v5 (`REQ-052` à `REQ-056`) citent `CR-05`, dont le
compte rendu porte lui-même un avertissement : il repose sur des propos
rapportés et non sur une source brute écrite. Il doit être relu par la
personne ayant mené l'échange avant que ces exigences soient considérées
comme définitives. Cinq lectures y restent en hypothèse d'équipe
(`CR-05` §6), tracées aux questions 11 à 14 du [§11](#11-questions-restées-ouvertes).

Toutes les autres exigences ont été dites explicitement par le client.
`./tools/traceability.sh` vérifie que chaque `REQ` a une source, que
l'échange cité existe réellement dans les comptes rendus, et qu'aucune
exigence n'est laissée sans spécification.

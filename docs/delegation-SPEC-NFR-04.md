...
|---|---|---|
| 1 | `repris` | ni `BonCadeau` ni `Avoir` ne portaient de donnée personnelle : la purge n'avait rien à épargner sur eux. Colonne `email_beneficiaire` ajoutée aux deux tables |
| 2 | `conforme` |  |
